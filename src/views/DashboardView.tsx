...
export default function DashboardView() {
    ...
    // "{}" contiene por defecto varias utilidades, googlear TanStack query
    ...
    /* data:user --> de esta forma estamos renombrando prq sino se pisan los nombres con otras variables */
